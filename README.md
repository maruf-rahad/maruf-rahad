# Hi there, I'm Maruf Ahmed Rahad 👋

### 👨‍💻 Software Engineer (Backend) | Stockholm, Sweden
Backend Software Engineer with **4+ years of experience** building secure, high-performance, and scalable software systems across Europe and Asia. Proven track record at **Samsung R&D Institute**, **Faverli**, and **BRAC IT Services**, specializing in **Java, Spring Boot, PostgreSQL, C++, and Distributed Architecture**.
...
- 🏆 **Competitive Programming:** **Codeforces Specialist**, **3x ICPC Regionalist** (2018, 2019, 2020), **1,500+ problems solved** across online judges.
- 🎖️ **Awards:** 2x Samsung Excellence Award recipient & Disclosure of Innovation (DOI) Award winner.
- 📜 **Certification:** Samsung Software Competency (SWC) Professional Level.

---

## 🛠️ Technical Skills

- **Languages:** Java (17/21), C/C++, C#, Python, SQL, TypeScript
- **Frameworks & Tech:** Spring Boot 3, Spring Security, Spring Data JPA, Hibernate, .NET Core, WebSockets (STOMP)
...
<p align="left">
  <img src="https://github-readme-stats.vercel.app/api?username=maruf-rahad&show_icons=true&theme=tokyonight" alt="Maruf's GitHub Stats" width="48%" />
  <img src="https://github-readme-stats.vercel.app/api/top-langs/?username=maruf-rahad&layout=compact&theme=tokyonight" alt="Top Languages" width="48%" />
</p>
